...
public class TrainingProgramService : ITrainingProgramService
{
    ...
    public async Task<Result<TrainingProgramDTO>> CreateTrainingProgramFromJSON(
        IdentityUser user,
    ...
    var newProgram = new TrainingProgram {
        ...
        foreach (var sessionDto in trainingProgramDTO.TrainingSessions)
        {
            ...
            {
                var baseEntity = await _context.MovementBases
                                    .FindAsync(mDto.MovementBaseID)!;
                ...
                var newMovement = new Movement {
                    ...
                    MovementModifier  = mDto.MovementModifier,
                    Notes             = mDto.Notes,
