...
namespace lionheart.Endpoints.ChatEndpoints
{
        ...
        .WithActionResult<ChatConversationDTO>
    {
        ...
        public override async Task<ActionResult<ChatConversationDTO>> HandleAsync(CreateChatConversationRequest request, CancellationToken cancellationToken = default)
        {
